            ...
            <div class="self-center mt-0 ml-5 w-full max-w-[1056px] max-md:max-w-full">
                <div class="flex gap-5 max-md:flex-col">
                    ...
                    <div class="p-10 bg-blue-950 text-white max-w-lg mx-auto rounded-lg">
                        <!-- Judul -->
                        <h2 class="text-3xl font-bold text-blue-400 mb-6 italic">Mitra</h2>
                    
                        <!-- Deskripsi -->
                        <p class="text-lg leading-relaxed mb-6">
                        Bermitra dengan PSS adalah sebuah upaya sinergi dan kolaborasi dari berbagai pihak untuk mewujudkan dampak yang lebih luas. 
                        </p>
        
                        <p class="text-lg leading-relaxed mb-6">
                        Kami percaya dengan kolaborasi yang baik, ide dan masukan yang cemerlang dan passion untuk sama-sama menyelamatkan lingkungan, akan mengkristal menjadi program-program baik dan impactful.  
                        </p>
        
                        <p class="text-lg leading-relaxed mb-6">
                        Kami mengajak individu, komunitas, perusahaan, organisasi masyarakat serta intansi dinas yang sama-sama memiliki panggilan untuk melestarikan bumi, bergabung di PSS.
                        </p>
