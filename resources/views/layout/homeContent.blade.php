<section class="flex flex-col pt-14 sm:pt-20 md:pt-24 lg:pt-28 w-full bg-stone-50 max-w-full" style="background-color: #F9F9F9;">
    <section class="self-start w-full ml-80 max-w-auto sm:max-w-auto md:max-w-[1340px]">
        <div class="flex flex-col md:flex-row gap-5">
            <div class="flex flex-col w-full ml-40 md:w-auto">
                <div class="flex flex-col grow text-3xl sm:text-4xl md:text-5xl font-bold text-blue-950 mt-2 sm:mt-6 md:mt-8 max-w-full">
                    <h2 class="self-start">Tentang Kami</h2>
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/8afcd4e650988af0c30702d2dd7a6ea2885c6bd7c0e8c398cfb339632e3cc603?placeholderIfAbsent=true&apiKey=c1377a7c791a4a95a2c1ef4a3fe24484" alt="Illustration representing Peduli Sungai Surabaya's mission" class="object-contain mt-8 ml-14 sm:mt-10 md:mt-14 w-full rounded-xl aspect-[1.23] max-w-full" />
                </div>
            </div>
    ...
    <div class="flex relative flex-col mt-14 sm:mt-20 md:mt-24 lg:mt-28 w-full min-h-auto sm:min-h-auto md:min-h-auto lg:min-h-auto max-w-full">
        <img src="{{ asset('assets/Group 34.png') }}" alt="Deskripsi Gambar" class="w-auto max-w-auto">
    </div>
    <section class="flex flex-col self-center w-full max-w-auto sm:max-w-auto md:max-w-auto" style="background-color: #132A53;">
        ...
        <div class="flex flex-wrap gap-5 sm:gap-8 md:gap-10 justify-center items-center mt-10 sm:mt-14 md:mt-16 lg:mt-20 text-lg sm:text-xl font-bold text-center text-white">
            <article class="flex flex-col self-stretch mx-10 my-auto w-full sm:w-[45%] md:w-[325px]">
            ...
            <article class="flex flex-col self-stretch mx-10 my-auto whitespace-nowrap w-full sm:w-[45%] md:w-[325px]">
                <div class="flex relative flex-col pt-48 sm:pt-56 md:pt-64 w-full rounded-xl aspect-[0.74]">
            ...
            <article class="flex flex-col self-stretch mx-10 my-auto whitespace-nowrap w-full sm:w-[45%] md:w-[325px]">
                <div class="flex relative flex-col pt-48 sm:pt-56 md:pt-64 w-full rounded-xl aspect-[0.74]">
                    ...
                    <h3 class="relative px-10 mt-36 sm:px-12 md:px-16 py-2 sm:py-3 md:py-4 bg-blue-500 rounded-none">Pelatihan</h3>
                </div>
            </article>
        </div>
        <div class="flex relative flex-col mt-36 sm:mt-36 md:mt-36 lg:mt-36 mt w-full min-h-[200px] sm:min-h-[250px] md:min-h-[300px] lg:min-h-[342px] max-w-full">
            <img src="{{ asset('assets/Group 33.png') }}" alt="Deskripsi Gambar" class="w-auto max-w-auto">
        </div>
    </section>
    <section class="flex flex-col self-center w-full -mt-72 max-w-auto sm:max-w-auto md:max-w-auto" style="background-color: #F9F9F9;">
        <div class="flex flex-wrap gap-3 sm:gap-4 md:gap-5 justify-between mx-36 w-full font-bold max-w-[1996px] mt-20 sm:mt-24 md:mt-28 lg:mt-[474px] text-blue-950">
    ...
    <section class="self-start w-full ml-80 mt-60 max-w-auto sm:max-w-auto md:max-w-[1440px]">
        <div class="flex flex-col md:flex-row gap-5">
            ...
            <div class="flex flex-col items-start self-stretch w-full md:w-6/12 text-xl font-bold max-md:mt-10 mt-20 ml-36 max-w-full">
