...
<div class="bg-white">
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100 p-4">
        ...
        <div class="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg mt-5 mb-5">
          ...
          <form id="addItemForm" enctype="multipart/form-data" method="POST" action="{{ route('admin.store.post') }}">
            @csrf
            <!-- Title Input -->
            <div class="mb-4">
            ...
            <div class="flex justify-end">
                <button id="addButton" class="mt-4 bg-blue-500 text-white py-2 px-4 rounded-[50px] hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Add
                </button>
            </div>
        </form>
